					...
					<div class="collapse" id="navbarToggleExternalContent">
						<div class=" p-4">
							...
							<ul class="nav navbar navbar-info">
								...
								<li class="nav-item"><a href="todas_tarefas.php" class="nav-link btn btn-outline-light active">Todas Tarefas</a>
								</li>
			...
			<div class="row">
				...
				<div class="col-sm-9">
					<div class="container pagina bg-white">
						<div class="row">
							<div class="col">
								<h4 class="">Todas tarefas</h4>
								<p class="lead mb-5" style="font-size: 1em;">Monitore todas as suas tarefas de um jeito pratico.</p>
								<hr />
								...
								<?php foreach ($tarefa as $key => $value) { ?>
									...
									<div class="row mb-3 d-flex align-items-center tarefa bord">
										<div id="tarefa_<?= $value->id ?>" class="col-lg-7"><?= $value->tarefa ?> <strong>(<?= $value->status ?>)</strong> </div>
										<div class="col-sm-5 d-flex justify-content-between">
											<span class="btn btn-outline-danger botoes" data-text="Excluir" onclick="excluir('<?= $value->id ?>')">
												<i class="fas fa-trash-alt fa-lg"></i>
											</span>

											<?php if ($value->id_status == 1) { ?>
												<span class="btn btn-outline-info botoes" data-text="Editar" onclick="editar('<?= $value->id ?>' , '<?= $value->tarefa ?>')">
													<i class="fas fa-edit fa-lg"></i>
												</span>
												<span class="btn btn-outline-success botoes" data-text="Finalizar" onclick="marcar(<?= $value->id ?>)">
